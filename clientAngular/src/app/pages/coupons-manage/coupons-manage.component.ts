...
*/
  ...
  ngOnInit(): void {
    ...
    this.form = this.fb.group({
      ...
      description: [null, Validators.compose([Validators.required, Validators.maxLength(120)])],
      expireDate: [null, Validators.compose([Validators.required])],
      newPrice: [null, Validators.compose([Validators.required, Validators.pattern("^[0-9]*$")])],
      oldPrice: [null, Validators.compose([Validators.required, Validators.pattern("^[0-9]*$")])],
      ...
      profile_Coupon: [null, Validators.compose([])],
  ...
  onUpdate(stateUpdatePressed: boolean, id: string) {
    if (stateUpdatePressed) {
      ...
      this.updateForm = this.fb.group({
        ...
        description: [this.updateCoupon.description, Validators.compose([Validators.required, Validators.maxLength(120)])],
        expireDate: [this.updateCoupon.expireDate, Validators.compose([Validators.required])],
        newPrice: [this.updateCoupon.newPrice, Validators.compose([Validators.required, Validators.pattern("^[0-9]*$")])],
        oldPrice: [this.updateCoupon.oldPrice, Validators.compose([Validators.required, Validators.pattern("^[0-9]*$")])],
